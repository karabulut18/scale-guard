...
const (
	RateLimitService_CheckRateLimit_FullMethodName = "/scaleguard.v1.RateLimitService/CheckRateLimit"
)
...
var RateLimitService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "scaleguard.v1.RateLimitService",
