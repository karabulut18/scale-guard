...
const file_ratelimit_proto_rawDesc = "" +
	"\n" +
	"\x0fratelimit.proto\x12\rscaleguard.v1\"Q\n" +
	"\x15CheckRateLimitRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\tR\bclientId\"h\n" +
	"\x16CheckRateLimitResponse\x12\x18\n" +
	"\aallowed\x18\x01 \x01(\bR\aallowed\x12\x1c\n" +
	"\tremaining\x18\x02 \x01(\x03R\tremaining\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason2q\n" +
	"\x10RateLimitService\x12]\n" +
	"\x0eCheckRateLimit\x12$.scaleguard.v1.CheckRateLimitRequest\x1a%.scaleguard.v1.CheckRateLimitResponseB0Z.github.com/karabulut18/scale-guard/internal/pbb\x06proto3"
...
var file_ratelimit_proto_goTypes = []any{
	(*CheckRateLimitRequest)(nil),  // 0: scaleguard.v1.CheckRateLimitRequest
	(*CheckRateLimitResponse)(nil), // 1: scaleguard.v1.CheckRateLimitResponse
}
var file_ratelimit_proto_depIdxs = []int32{
	0, // 0: scaleguard.v1.RateLimitService.CheckRateLimit:input_type -> scaleguard.v1.CheckRateLimitRequest
	1, // 1: scaleguard.v1.RateLimitService.CheckRateLimit:output_type -> scaleguard.v1.CheckRateLimitResponse
